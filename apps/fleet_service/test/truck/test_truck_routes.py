...
class TestTruckRoutes:
    def test_create_truck_endpoint(self):
    ...
    def test_get_trucks_endpoint_returns_created_trucks(self):
        client.post(
            "/trucks",
            json={
                "plate_number": "AB-123-CD",
    ...
    def test_create_truck_endpoint_rejects_invalid_capacity(self):
        response = client.post(
            "/trucks",
            json={
                "plate_number": "AB-123-CD",
    ...
    def test_create_truck_endpoint_rejects_duplicate_plate_number(self):
        client.post(
            "/trucks",
            json={
                "plate_number": "AB-123-CD",
