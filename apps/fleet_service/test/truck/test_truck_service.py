...
from apps.fleet_service.app.exceptions import InvalidTruckCapacity, DuplicatePlateNumber
from apps.fleet_service.app.models.truck import CreateTruckRequest, TruckStatus
