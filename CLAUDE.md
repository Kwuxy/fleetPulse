...
- `truck-departure-scheduled` — produced by Delivery Service on a successful assignment; not consumed yet (no consumer exists until `gps_simulator` is built — see Planned Features > Truck position tracking)
